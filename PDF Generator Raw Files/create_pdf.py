...
class PDFGenerator:
    ...
    def remove_transparency_with_hex(self, png_path, hex_bg="#FFFFFF"):
        """Remove transparency by applying hex background color"""
        ...
        if img.mode in ('RGBA', 'LA'):
            ...
            return png_path  # No alpha, return path as-is
    ...
    def _draw_header(self, data):
        ...
        if logo_path and os.path.exists(logo_path):
            try:
                ...
                image_data = self.remove_transparency_with_hex(logo_path, hex_bg="#FFFFFF")  # Or your chosen background
    ...
    def _draw_totals_and_payment_method(self, data):
        ...
        self._draw_text(data['paymentMethod']['paymentMethod2'], payment_method_x, current_y_left,
                        font_name='Helvetica', font_size=9, color=colors.HexColor('#666666'))
